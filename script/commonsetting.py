...
#training_dir = "/Users/zhengyuanrui/CNN/data/img/train"
val_dir = os.path.join(path, "data", "img", "validation")
#val_dir = "/Users/zhengyuanrui/CNN/data/img/validation"
test_dir = os.path.join(path, "data", "img", "test")
#test_dir = "/Users/zhengyuanrui/CNN/data/img/test"
...
label_map = dict(circle=0.5, triangle=1, square=0)
